            ...
            function renderProducts(){
                for(product of products){
                    ...
                    elProd.setAttribute('class','containerProd col-sm-12 col-md-6 col-lg-4 col-xl-4 card border-0')
            ...
            function addToCart(t){
                ...
                cart.push({id: products[t].id ,name: products[t].name, images: products[t].images, price: products[t].price, qtd: 1, qtdmax: products[t].qtd });
            ...
            function renderCart(c){
                ...
                for(product of cart){
                    ...
                    for(var d=1;d <= cart[j].qtdmax;d++){
                        var elQtdCartOp = document.createElement('option');

                        if(cart[j].qtd !== 1){
                            elQtdCartOp.setAttribute('value', cart[j].qtd);
                            elQtdCartOp.appendChild(document.createTextNode(cart[j].qtd));
                        }
                     ...
                     elQtdCart.addEventListener('change',function(c){
                   ...
                   cell5.innerHTML = '<i class="fas fa-trash-alt text-danger" onclick="removeOfCart('+j+')"></i>';
